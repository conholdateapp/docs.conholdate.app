...
1. From your [dashboard](https://conholdate.app/dashboard) open sharing dialog by clicking on <i class="fas fa-link"></i> icon next to document that you want to share.
...
1. From your [dashboard](https://conholdate.app/dashboard) open sharing dialog by clicking on <i class="fas fa-link"></i> icon.
